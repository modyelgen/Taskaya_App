...
class WarningOption extends StatelessWidget {
  const WarningOption({super.key,this.text});
  final String?text;
  @override
      ...
      child: CustomAlertWidget(
        title: Column(
          ...
          children: [
            ...
            Text(text??"Are you Sure to Delete ?",style: CustomTextStyle.fontBold18,overflow: TextOverflow.ellipsis,),
          ],
        ),
...
Future<bool> showConfirmDialog(BuildContext context,{String?text}) async {
  return await showGeneralDialog<bool>(
    ...
    pageBuilder: (BuildContext context,ani,anu) {
      return WarningOption(text: text);
    },
